...
func (r *Repo) AddToCart(ctx context.Context, userID int, productID int, quantity int) error {
	_, err := r.db.ExecContext(ctx, `INSERT INTO cart_items(user_id, product_id, quantity) VALUES($1, $2, $3);`, userID, productID, quantity)
	return err
}
